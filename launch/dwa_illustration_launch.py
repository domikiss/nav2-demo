...
def generate_launch_description():
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=os.path.join(
            local_dir, 'rviz', 'dwa_illustration.rviz'),
    ...
    start_nav_sim_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(local_dir, 'launch/tb3_nav_sim_launch.py')),
    ...
    ld.add_action(start_nav_sim_cmd)
